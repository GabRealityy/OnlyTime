    ...
    return (
        <div className="space-y-6">
            <div className="ot-card">
                ...
                <h1 className="text-2xl font-black tracking-tighter uppercase whitespace-nowrap text-success">Datenschutz</h1>
                ...
                <div className="mt-8 space-y-10">
                    ...
                    <div className="rounded-2xl border-2 border-success bg-success-bg p-6 shadow-xl shadow-success/5">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div className="text-sm font-black uppercase tracking-widest text-success">100% Lokal</div>
                        </div>
                    ...
                    <div className="border-l-2 border-border pl-6">
                        <div className="text-[10px] font-black uppercase tracking-widest text-tertiary mb-2">1. Verantwortlicher</div>
                        <div className="space-y-1 text-sm font-medium">
                            <p className="font-bold text-primary">Swiss Innovation Studios</p>
                            <p>Meierenaustrasse 18</p>
                            <p>9443 Widnau, Schweiz</p>
                            <a href="mailto:swissinnovationstudios@gmail.com" className="text-success hover:underline inline-block mt-1">
                    ...
                    {/* Art der Daten */}
                    <div className="border-l-2 border-border pl-6">
                        <div className="text-[10px] font-black uppercase tracking-widest text-tertiary mb-2">2. Verarbeitete Daten</div>
                    ...
                    {/* Analyse */}
                    <div className="border-l-2 border-border pl-6">
                        <div className="text-[10px] font-black uppercase tracking-widest text-tertiary mb-2">3. Tracking & Analyse</div>
                        <p className="text-sm text-secondary leading-relaxed">
            ...
            <div className="text-center text-[10px] uppercase tracking-widest text-tertiary font-black mb-8">
                Stand: Januar 2026
            </div>
        </div>
    )
